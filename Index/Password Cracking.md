...
In this machine a pfsafe3 file was cracked using hashcat.

+ [Anonforce](../THM/Anonforce.md) 

After getting a pgp and asc file john was used to get the passphrase of the pgp file, inside that file was a password hash which was also cracked using john.
