...
What matters to us here it's that CBC will use the previous block to decrypt the current one through XOR
...
37 being te result of the secret "56" and our "a" aka "61" which it's the letter that we want as a result
